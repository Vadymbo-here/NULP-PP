    ...
    public static void genMenu(User user) {
        while (true) {
            ...
            if (com == null) {
                ...
                switch (user.getRole()) {
                    case 0:
                        System.out.println(menuItemsU.get(userInput[0] + " " + userInput[1]).execute(userInput));
                        break;

                    case 1:
                        System.out.println(menuItemsA.get(userInput[0] + " " + userInput[1]).execute(userInput));
                        break;
